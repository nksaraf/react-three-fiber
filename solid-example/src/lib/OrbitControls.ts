...
import { ThreeTypes, useFrame, useThree } from 'solid-three'

export type OrbitControlsProps = ThreeTypes.Overwrite<
  ThreeTypes.Object3DNode<OrbitControlsImpl, typeof OrbitControlsImpl>,
  {
...
export const OrbitControls = (props: OrbitControlsProps) => {
  ...
  const orbitControls = createMemo(() => new OrbitControlsImpl(defaultCamera()))
  ...
  createEffect(() => {
    ...
    onCleanup(() => {
      ...
      if (props.onStart) orbitControls().removeEventListener('start', props.onStart)
