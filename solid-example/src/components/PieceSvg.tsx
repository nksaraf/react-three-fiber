import { BISHOP, BLACK, KING, KNIGHT, PAWN, QUEEN, ROOK, WHITE } from '../lib/chess'
import { Piece, Color, PieceSymbol } from '../lib/chess/types'
...
console.log(map)
export function ChessPieces(props: { piece: PieceSymbol; color: Color }) {
  return (
    ...
    <g style="opacity:1; fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(135,45)">
      ...
      <Dynamic component={map[props.piece][props.color]} />
    </svg>
  )
}
